...
import { findTagsOid, getArticlesNames, getArticlesNamesAndOid, getAuthorsNames, loadFile, loginUser, newArticle, newAuthor, newSummary, newTags, registerUser } from './utils/restful_connections';
